...
namespace RTG
{
    ...
    public class PostObjectTransformsChangedAction : IUndoRedoAction
    {
        ...
        private OperatorTranslateCommand _operatorTranslateCommand;
                                                 ...
                                                 List<LocalTransformSnapshot> postChangeTransformSnapshots)
        {
            ...
            _operatorTranslateCommand = new OperatorTranslateCommand(_preChangeTransformSnapshots, _postChangeTransformSnapshots);
        }

        public void Execute()
        {
            RTUndoRedo.Get.RecordAction(this);
            _operatorTranslateCommand.Execute();
        }
        ...
        public void Undo()
        {
            ...
            _operatorTranslateCommand.Undo();
        }
