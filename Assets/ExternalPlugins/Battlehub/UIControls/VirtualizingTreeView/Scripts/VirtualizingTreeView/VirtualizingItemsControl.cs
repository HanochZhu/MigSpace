...
namespace Battlehub.UIControls
{
    ...
    public class VirtualizingItemsControl : Selectable,  IDropHandler, IUpdateSelectedHandler, IUpdateFocusedHandler
    {
        ...
        public IEnumerable Items
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    {
                        if (!m_itemContainerData.ContainsKey(items[i]))
                        {
                            EventManager.TriggerEvent("OnInputHitModelChangeList", m_itemContainerData.GetValueOrDefault(items[i]));
        ...
        protected override void OnEnable()
        {
            ...
            EventManager.StartListening(Events.OnDeleteItems, RemoveSelectedItems);
            OnEnableOverride();
        }
        ...
        public void RemoveSelectedItems(object arg0 = null, object arg1 = null)
        {
            if (m_selectedItems == null)
            {
                return;
        ...
        public virtual ItemContainerData Insert(int index, object item)
        {
            ...
            {
                Debug.Log("Have item" + item);
                itemContainerData = InstantiateItemContainerData(item);
        ...
        public override void OnSelect(BaseEventData eventData)
        {
            ...
            if (m_scrollRect.Items[m_selectedIndex] != null)
            {
                Debug.Log("OnSelect :" + m_scrollRect.Items[m_selectedIndex]);
                EventManager.TriggerEvent(MigEventCommon.OnClickModel, m_scrollRect.Items[m_selectedIndex]);
            }
